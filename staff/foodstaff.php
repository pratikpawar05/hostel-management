            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Food Staff Approval</h5>
                                <!-- Table component -->
                                <div class="table-responsive">
                                    <table class="table table-centered table-nowrap table-hover mb-0" id="futureStaff">
                                        ...
                                        <tbody>
                                            <?php $sql = "SELECT * FROM staffs inner join staff_type on staffs.s_type_id=staff_type.s_type_id where staffs.s_type_id='3' and staffs.s_status='0'";
                                            $result = mysqli_query($conn, $sql);
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">All Food Staff</h5>
                                <!-- Table component -->
                                <div class="table-responsive">
