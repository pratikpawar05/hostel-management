                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-centered table-nowrap table-hover mb-0" id="futureStaff">
                                        ...
                                        <tbody>
                                            <?php $sql = "SELECT * FROM staffs inner join staff_type on staffs.s_type_id=staff_type.s_type_id where staffs.s_type_id='2' and staffs.s_status='0'";
                                            $result = mysqli_query($conn, $sql);
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="currentStaff" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * FROM staffs inner join staff_type on staffs.s_type_id=staff_type.s_type_id where staffs.s_type_id='2' and staffs.s_status='1'";
                                            $result = mysqli_query($conn, $sql);
                                            while ($data = mysqli_fetch_assoc($result)) { ?>
                                                <tr>
                                                    <td><?php echo $data['s_f_name'] ?></td>
