...
session_start();
$checkin=mysqli_real_escape_string($conn, htmlspecialchars($_POST['start_date']));
$a=date_create($checkin);
$start_date=date_format($a,"Y-m-d 01:00:00");
$checkout=mysqli_real_escape_string($conn, htmlspecialchars($_POST['end_date']));
$b=date_create($checkout);
$end_date=date_format($b,"Y-m-d");
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-centered table-nowrap table-hover mb-0" id="bookings">
                                        ...
                                        <tbody>
                                            <?php 
                                            $sql="SELECT * FROM `bookings` WHERE (B_CHECK_IN_DATE BETWEEN '$start_date' AND '$end_date' OR B_CHECK_OUT_DATE BETWEEN '$start_date' AND '$end_date')";
